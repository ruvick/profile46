...
function init() {
	...
	myGeoObjects[0] = new ymaps.Placemark([51.730110, 36.249851], {
		// Свойства. 
		// hintContent: '<div class="map-hint">Авто профи, Курск, ул.Комарова, 16</div>',
		balloonContent: '<div class="map-hint">"Профиль46", Курск, ул.Соловьиная 66А</div>',
	}, {
