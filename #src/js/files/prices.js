document.addEventListener('DOMContentLoaded', function () { 
    ...
    for (let index = 0; index < all_select_options.length; index++) { 
        all_select_options[index].addEventListener('click', function () { 
              let size = all_select_options[index].innerHTML
              console.log(size)
    ...
    all_select_options = document.querySelectorAll("#zink_price_blk_27_28 .select__option");
    ...
    all_select_options = document.querySelectorAll("#polimer_price_blk_60_27 .select__option");
